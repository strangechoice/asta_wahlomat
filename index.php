...
<html>
  ...
  <h1><small>Der</small> <?php echo $config['name']; ?></h1>
    ...
    <p>Der <?php echo $config['name']; ?> ist ein technisches Hilfsmittel, das es ermöglicht, zu ausgewählten Themen die eigenen Standpunkte mit denen der Listen abzugleichen, die z Wahl antreten.</p>
